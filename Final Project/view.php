...
<button type="button" class="btn btn-danger"><a href="view.php?deletedID=<?php echo $user['id']; ?>" onclick="confirm('Are you sure you want to delete this record?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
<button type="button" class="btn btn-warning"><a href="logout.php">Log Out</a></button>
</main>
