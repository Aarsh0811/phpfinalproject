...
<!-- adding our carousels which will automatically change -->
      ...
      <!-- to display alert -->
      <?php
      if (isset($_GET['msg17']) == "loggedout") {
          echo "<div class='alert alert-success alert-dismissible'>
           <button type='button' class='close' data-dismiss='alert'>x</button>
          <strong>Success! </strong> Your have been logged out!
        ...
        <section id="scroll">
              <div class="container px-5">
                  <div class="row gx-5 align-items-center">
                      <div class="col-lg-6 order-lg-2">
                          <div class="p-5"><img class="img-fluid rounded-circle" src="./img/bg-showcase-1.jpg" alt="..." /></div>
                      </div>
          ...
          <section>
              <div class="container px-5">
                  <div class="row gx-5 align-items-center">
                      <div class="col-lg-6">
                          <div class="p-5"><img class="img-fluid rounded-circle" src="./img/bg-showcase-2.jpg" alt="..." /></div>
                      </div>
                      <div class="col-lg-6">
                          <div class="p-5">
          ...
          <section>
              <div class="container px-5">
                  <div class="row gx-5 align-items-center">
                      <div class="col-lg-6 order-lg-2">
                          <div class="p-5"><img class="img-fluid rounded-circle" src="./img/bg-showcase-3.jpg" alt="..." /></div>
                      </div>
                      <div class="col-lg-6 order-lg-1">
                          <div class="p-5">
